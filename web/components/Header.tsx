  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-space-black/80 backdrop-blur-md border-b border-white/10 py-4' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center relative">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-mono absolute left-1/2 -translate-x-1/2">
        ...
        <div className="flex items-center gap-4">
          <a 
            href="https://github.com/s4tvara/voidcast" 
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 border border-white/20 hover:border-white/40 hover:bg-white/5 text-white px-4 py-1.5 rounded-full text-xs font-mono transition-all"
          >
